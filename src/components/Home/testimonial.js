      ...
      <Fade bottom>
        <div className="w-full h-full  flex flex-row justify-between align-middle bg-[url('../images/holographic-background.webp')] p-12 rounded-lg xxs:flex-col xs:flex-col sm:flex-row xxs:p-5 lg:p-12">
          <div className="w-3/4 xxs:w-full xs:w-full backdrop-blur-sm bg-white/30 p-10 rounded-lg lg:p-10">
            <div className="text-primaryText font-semibold text-xl xxs:text-s xxs:font-normal sm:text-xl font-notoserif">
            ...
            <div className="mt-10">
              <h3 className="text-primaryText text-2xl font-smibold">Lorem Ipsum</h3>
              <p className="text-primaryText text-sm font-semibold opacity-50">
                Google review
              </p>
            </div>
          </div>
